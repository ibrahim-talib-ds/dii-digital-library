...
class GetBooksCall {
  static Future<ApiCallResponse> call() async {
    return ApiManager.instance.makeApiCall(
      callName: 'GetBooks',
      apiUrl:
          'https://naturally-satisfy-motivated-campbell.trycloudflare.com/books',
  ...
  static List? books(dynamic response) => getJsonField(
        response,
        r'''$.books''',
        true,
      ) as List?;
  ...
  static List<String>? description(dynamic response) => (getJsonField(
        ...
        true,
          ...
          .withoutNulls
          .toList();
  static List<String>? coverimage(dynamic response) => (getJsonField(
        response,
        r'''$.books[:].cover_image''',
        true,
      ) as List?)
          ...
          .withoutNulls
          .toList();
  static List<String>? pdfurl(dynamic response) => (getJsonField(
        response,
        r'''$.books[:].pdf_url''',
        true,
      ) as List?)
          ...
          .withoutNulls
          .toList();
  static List<int>? pages(dynamic response) => (getJsonField(
        response,
        r'''$.books[:].pages''',
        true,
      ) as List?)
