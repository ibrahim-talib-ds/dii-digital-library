...
/// Functions to query BorrowingsRecords (as a Stream and as a Future).
Future<int> queryBorrowingsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BorrowingsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BorrowingsRecord>> queryBorrowingsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BorrowingsRecord.collection,
      BorrowingsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BorrowingsRecord>> queryBorrowingsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
