...
import 'contact_option_model.dart';
export 'contact_option_model.dart';
...
class ContactOptionWidget extends StatefulWidget {
  const ContactOptionWidget({
    ...
    this.icon,
    String? title,
  }) : this.title = title ?? 'Ask a Question';
...
class _ContactOptionWidgetState extends State<ContactOptionWidget> {
  late ContactOptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactOptionModel());
