  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<BooksRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BooksRecord> categoryBooksPageBooksRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final categoryBooksPageBooksRecord =
            categoryBooksPageBooksRecordList.isNotEmpty
                ? categoryBooksPageBooksRecordList.first
                : null;
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<List<BooksRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<BooksRecord> gridViewBooksRecordList =
                                snapshot.data!;
                            ...
                            return GridView.builder(
                              ...
                              itemCount: gridViewBooksRecordList.length,
                              itemBuilder: (context, gridViewIndex) {
                                final gridViewBooksRecord =
                                    gridViewBooksRecordList[gridViewIndex];
                                return InkWell(
                                  splashColor: Colors.transparent,
                                  focusColor: Colors.transparent,
                                  hoverColor: Colors.transparent,
